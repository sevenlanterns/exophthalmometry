...
def record_loop(hw, hh, fps):
    ...
    while not record_stop_event.is_set():
        ...
        # The main stream comes out of libcamera as BGR in memory even though
        # it is labelled RGB888. ffmpeg's rgb24 expects true R-G-B byte order,
        # so swap channels here. This is what makes preview colours correct too.
        ...
        try:
            ffmpeg_process.stdin.write(cropped_rgb.tobytes())
